...
| 主会话 | 记忆只读：`memory_search/get/list/activity/decide`；不会暴露 LLM-facing 写记忆工具。Policy/session-start push 对所有 persisted main session 只使用 ADR0040 stable view；ephemeral/subagent 排除。 |
