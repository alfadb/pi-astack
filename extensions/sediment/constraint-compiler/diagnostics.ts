...
export const DIAGNOSTIC_CONSUMERS: Record<ConstraintShadowDiagnosticCode, ConstraintShadowDiagnosticConsumer[]> = {
  ...
  SC_NOT_MEMORY_SUBTYPE_NORMALIZED: ["not_memory_audit", "compiler_prompt_iteration", "manual_investigation"],
  SC_DIAGNOSTIC_DECISION_INCONSISTENCY: ["compiler_prompt_iteration", "manual_investigation"],
  ...
  SC_MERGED_SOURCE_VERIFIER_PARSE_FAILED: ["compiler_liveness_report", "manual_investigation"],
  SC_MERGED_SOURCE_VERIFIER_MODEL_UNAVAILABLE: ["compiler_liveness_report", "manual_investigation"],
  SC_COMPILER_RETRY_ATTEMPT: ["compiler_liveness_report", "manual_investigation"],
  SC_COMPILER_ITEM_REJECTED: ["compiler_prompt_iteration", "scope_review", "manual_investigation"],
  SC_EXCLUSION_REASON_RECLASSIFIED: ["compiler_prompt_iteration", "scope_review", "manual_investigation"],
  SC_SOURCE_MULTI_HOME_QUARANTINED: ["compiler_prompt_iteration", "manual_investigation"],
  SC_EXCLUSION_DEDUPED: ["compiler_prompt_iteration", "manual_investigation"],
  SC_MAPPING_DISPOSITION_NORMALIZED: ["compiler_prompt_iteration", "manual_investigation"],
  SC_UNSUPPORTED_MERGE_REVIEW_PAIR_QUARANTINED: ["compiler_prompt_iteration", "manual_investigation"],
  SC_EMPTY_CONSTRAINT_DROPPED: ["compiler_prompt_iteration", "manual_investigation"],
  SC_ACTIVE_EXCLUSION_DROPPED: ["compiler_prompt_iteration", "manual_investigation"],
  ...
  SC_MERGED_SOURCE_VERIFIER_NOT_EXPRESSED: ["compiler_liveness_report", "p3_injection_readiness", "manual_investigation"],
...
const DEFAULT_SEVERITY: Record<ConstraintShadowDiagnosticCode, ConstraintShadowDiagnosticSeverity> = {
  ...
  SC_NOT_MEMORY_SUBTYPE_NORMALIZED: "info",
  SC_DIAGNOSTIC_DECISION_INCONSISTENCY: "warning",
  ...
  SC_MERGED_SOURCE_VERIFIER_PARSE_FAILED: "warning",
  SC_MERGED_SOURCE_VERIFIER_MODEL_UNAVAILABLE: "warning",
  SC_COMPILER_RETRY_ATTEMPT: "info",
  SC_COMPILER_ITEM_REJECTED: "warning",
  SC_EXCLUSION_REASON_RECLASSIFIED: "warning",
  SC_SOURCE_MULTI_HOME_QUARANTINED: "warning",
  SC_EXCLUSION_DEDUPED: "info",
  SC_MAPPING_DISPOSITION_NORMALIZED: "info",
  SC_UNSUPPORTED_MERGE_REVIEW_PAIR_QUARANTINED: "info",
  SC_EMPTY_CONSTRAINT_DROPPED: "warning",
  SC_ACTIVE_EXCLUSION_DROPPED: "warning",
  ...
  SC_MERGED_SOURCE_VERIFIER_NOT_EXPRESSED: "warning",
