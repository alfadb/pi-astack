 ...
 *   4. cleanup_done is `false`: a stale heartbeat proves liveness loss, not
 *      process/session closure. Only the dispatch termination join may stamp
 *      true after observing both worker settlement and session disposal.
 *
