...
| ADR0040 proposition / lifecycle freshness | Production status, exact phase boundaries and machine evidence are indexed by the [transition register](./transition-register.md). The canonical long-term contracts are [proposition contracts](./notes/adr0040-proposition-contracts.md) and [D3 lifecycle freshness design](./notes/adr0040-d3-lifecycle-freshness-design.md); production D3 generation 0 remains runtime-inert, and P1 consumer flip, P3 runtime read flips and P4 legacy authority retirement remain separately blocked. |
