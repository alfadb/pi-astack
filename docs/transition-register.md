...
|---|---|---|---|---|---|
| canonical_path P1 | 2026-07-10 | `in_progress / authorized`；P1-S3 已完成，P1-S1/S2 implementation candidate 已通过 synthetic smoke 与独立审查，P1-S4/P1-B/P1-A 待执行；不改变 Knowledge/Constraint canonical read 或 fold。 | P1-S3/S1/S2/S4、P1-B、P1-A 全部有真实外部证据，且 completion record 落盘。 | R3.4.2 living plan、P1 baseline dossier。 | 继续 P1-S4，再执行 P1-B production-trace replay 与 P1-A controlled drains；不得用 synthetic smoke 替代 production acceptance，也不得自动越过 P1 授权边界。 |
...
| staging 硬删 | 2026-07-08 审计登记 | staging backlog 仍需按 inventory/metrics 指针评估；canonical-path recovery primitive 已有 implementation candidate，但尚未通过 P1-B/P1-A production acceptance，且不构成 staging 硬删授权。 | recovery primitive 完成 production acceptance，并完成硬删 runbook、回滚验证与独立授权。 | staging inventory、promotion/ageout metrics、canonical-path P1 completion dossier。 | 等待 recovery primitive 完成 P1 production acceptance；另行完成硬删 runbook、回滚验证与授权后再讨论硬删。 |
