...
| [0039](./0039-constraint-pipeline-reset.md) | **Constraint Pipeline Reset** | Accepted（2026-06-18，4×T0 多轮讨论 + 草稿 R2 全部 SIGN）；约束写入从实时 active rule mutation 改为 append-only Draft/Event → 后台 compiler → 稳定 Compiled Constraint View |
