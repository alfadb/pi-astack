...
| **garrytan/gstack** | 上游开源 | `pi-astack/vendor/gstack/` | 移植参考 | read-only submodule |
...
| 组件 | 上游 | 用途 |
|---|---|---|
| **garrytan/gstack** | github.com/garrytan/gstack | 19 skills 已迁入 pi-astack/skills/，vendor 仅作未来移植参考 |
