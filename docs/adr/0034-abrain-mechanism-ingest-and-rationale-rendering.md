...
- **依赖**：[ADR 0003](0003-main-session-read-only.md)（主会话只读 / sediment 单写）、[ADR 0024](0024-second-brain-from-natural-conversation.md)（四 invariant + AI-Native）、[ADR 0025](0025-sediment-meta-curator-subsystem.md)（已归档至 abrain；**本 ADR 仅复用其 sanitizer + writer 基建，不依赖其稳态 curator 管线**）、[ADR 0028](0028-sediment-ground-truth-tiered-rearchitecture.md)（ground-truth 分层 + AX-PROVENANCE 门控）；[`docs/README.md`](../README.md)(两库章程 §4 承重墙 / §5 升级 / §7 迁移)、[`docs/direction.md`](../direction.md)、[`docs/requirements.md`](../requirements.md)。
